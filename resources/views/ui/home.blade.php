...
@section('main')
  ...
  <div class="container-xxl py-5">
    ...
    <div class="row g-5">
      ...
      <div class="position-relative h-100">
        <img class="img-fluid position-absolute w-100 h-100" src="{{ asset('/images/images/about.jpg') }}" alt=""
      ...
      <p class="mb-4">It was time to get rid of the vines. God, God, let it be God. Somewhere I'm going to have a
        backyard and them. Clita was the very same thing.</p>
      <p class="mb-4">It was time to get rid of the vines. God, God, let it be God. Somewhere I'm going to have a
        backyard and them. There was a great deal of pain and suffering, but it was a great deal of pain</p>
  ...
  <div class="container-xxl py-5" data-aos="fade-up" data-aos-delay="100">
    ...
    <div class="owl-carousel testimonial-carousel position-relative">
      ...
      <img class="border rounded-circle p-2 mx-auto mb-3" src="{{ asset('/images/images/testimonial-1.jpg') }}"
        style="width: 80px; height: 80px;">
      <h5 class="mb-0">Client Name</h5>
      <p>Profession</p>
      <div class="testimonial-text bg-light text-center p-4 shadow-sm rounded">
        <p class="mb-0">It was time to get rid of the vines. Diam pain diam diam diam diam diam diam diam and them.
        Clita was the very same thing.</p>
      </div>
      </div>
      <div class="testimonial-item text-center">
      <img class="border rounded-circle p-2 mx-auto mb-3" src="{{ asset('/images/images/testimonial-2.jpg') }}"
        style="width: 80px; height: 80px;">
      <h5 class="mb-0">Client Name</h5>
      <p>Profession</p>
      <div class="testimonial-text bg-light text-center p-4 shadow-sm rounded">
      ...
      <div class="testimonial-item text-center">
      <img class="border rounded-circle p-2 mx-auto mb-3" src="{{ asset('/images/images/testimonial-3.jpg') }}"
        style="width: 80px; height: 80px;">
      <h5 class="mb-0">Client Name</h5>
      <p>Profession</p>
      <div class="testimonial-text bg-light text-center p-4 shadow-sm rounded">
      ...
      <div class="testimonial-item text-center">
      <img class="border rounded-circle p-2 mx-auto mb-3" src="{{ asset('/images/images/testimonial-4.jpg') }}"
        style="width: 80px; height: 80px;">
      <h5 class="mb-0">Client Name</h5>
      <p>Profession</p>
      <div class="testimonial-text bg-light text-center p-4 shadow-sm rounded">
